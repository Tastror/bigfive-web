const hindi = {
  ...
  frontpage: {
    ...
    compare: {
      ...
      action: 'अभी तुलना करें',
      text: 'अपने परिणामों की तुलना अपने साथी, सहकर्मियों, दोस्तों या परिवार के सदस्यों के परिणामों से करें और जानें कि पाँच आयामों में आप एक-दूसरे से कैसे भिन्न हैं।'
    },
  ...
  getResult: {
    result: 'परिणाम',
    explanation:
      'यदि आपने टेस्ट पूरा करने के बाद परिणाम की आईडी सेव की थी, तो अपना परिणाम देखने के लिए उसे नीचे दर्ज करें।',
